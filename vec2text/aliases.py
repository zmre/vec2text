...
CHECKPOINT_FOLDERS_DICT = {
    ...
    "dpr_nq__msl32_beta": f"{DATASET_CACHE_PATH}/saves/db66b9c01b644541fedbdcc59c53a285/ebb31d91810c4b62d2b55b5382e8c7ea",
    ...
    "gtr_nq__msl128_beta": f"{DATASET_CACHE_PATH}/saves/8631b1c05efebde3077d16c5b99f6d5e/dc72e8b9c01bd27b0ed1c2def90bcee5",
    #  https://wandb.ai/jack-morris/emb-correct-1/runs/e9430bc73cfd6fb433eb0e5401d4a7ff [loss .644]
    "gtr_nq__msl32_beta__correct": f"{DATASET_CACHE_PATH}/saves/47d9c149a8e827d0609abbeefdfd89ac",
    # https://wandb.ai/jack-morris/emb-correct-1/runs/aa389ad434c01b692df796c2e2eb599c?workspace=user-jxmorris12 [loss .82]
    "gtr_nq__msl32_beta__correct__nofeedback": f"{DATASET_CACHE_PATH}/saves/f031f2b69c815cca265dd791473de60a",
    # https://wandb.ai/jack-morris/emb-inv-3/runs/35f5983783e5d6c7613aa14b84af1ff6/overview?workspace=
    "clinicalbert_nq__msl32": f"{DATASET_CACHE_PATH}/saves/01c63decd9009f5961504b52a96cd324",
    ####################################################################
    ############################# MSMARCO ##############################
    ####################################################################
    ...
    # "gtr_msmarco__msl128__100epoch": "f{DATASET_CACHE_PATH}/saves/d6312870a6f49dee914198d048ee88f4",
    "gtr_msmarco__msl128__100epoch": f"{DATASET_CACHE_PATH}/saves/gtr-1",
    ...
    "openai_msmarco__msl32__100epoch": "f{DATASET_CACHE_PATH}/saves/61becf9bb1d627272cd1923ac4871e73",
    # openai corrector model [sl32] [loss 0.77, bleu 45]
    "openai_msmarco__msl32__100epoch__correct": "f{DATASET_CACHE_PATH}/saves/7758f43e621db8ee718306f31139e3b0",
    ...
    "openai_msmarco__msl128__100epoch": "f{DATASET_CACHE_PATH}/saves/f9abd65db4c4823264b133816d08612f",
    ...
    "openai_msmarco__msl128__100epoch__correct": "f{DATASET_CACHE_PATH}/saves/d6ec9d5838a4ad3daeba636e5378a8a0",
    ...
    "openai_msmarco__msl128__200epoch__correct": "f{DATASET_CACHE_PATH}/saves/c7be16d4af952eea8046a02a9d2a2113",
    "logits__gpt2": "f{DATASET_CACHE_PATH}/vec2text/saves/9a73ba8ce560ec71a1f7a46b31674841",
    # "TEST_MODEL": "f{DATASET_CACHE_PATH}/vec2text/saves/c52ed653690fee956069a64f69a0ce05",
    "t5-base___llama-7b___one-million-paired-instructions": f"{DATASET_CACHE_PATH}/saves/cd8e3e3dec1a79babb508c3edd7fe5d3",
    "t5-base__llama-7b__one-million-paired-instructions": f"{DATASET_CACHE_PATH}/saves/dda9034471bab47f202eb37f5200a272",
    "t5_base__llama-7b__one-million-instructions__correct__70epoch": f"{DATASET_CACHE_PATH}/saves/logits-corrector-2",
    "t5-base___llama-7b___one-million-instructions__correct": f"{DATASET_CACHE_PATH}/saves/logits-corrector-4",
}
